...
const deleteUntil_post = defineEventHandler(async (event) => {
  ...
  await emitToUser(user.id, "chat.messages.deleted", {
...
export { deleteUntil_post as default };
//# sourceMappingURL=delete-until.post.mjs.map
